...
// Finally, it smoothes the previous and new values together instead of just setting them
#define X_SMOOTHING                 0.20           // smoothing for X axis acceleration
#define Y_SMOOTHING                 1              // smoothing for Y axis acceleration
